...
Group.new('DiffAdd', colors.nord_0, colors.green, styles.bold, colors.green)
Group.new('DiffChange', colors.nord_0, colors.yellow, styles.bold, colors.yellow)
Group.new('DiffDelete', colors.nord_0, colors.bey_red, styles.bold)
Group.new('DiffText', colors.blue, colors.nord_3, styles.bold, colors.blue)
...
Group.new("Delimiter", colors.nord_4, colors.none, styles.NONE) --brackets,parentesis,etc
...
Group.new("Folded", colors.nord_3_light, colors.nord_1, styles.bold)
Group.new("PMenuSel", colors.bey_sky, colors.nord_3, styles.NONE)
Group.new("Visual", colors.fg, colors.nord_3_light) --seleccion
----------------------
...
Group.new("LineNr", colors.nord_3_light, colors.none, styles.NONE)
